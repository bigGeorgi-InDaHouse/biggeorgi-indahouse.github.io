      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link to="/" className="block" aria-label="VSG">
              <svg className="w-8 h-8 fill-current text-purple-100 hover:text-orange-100" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <Dropdown title="Support">
                {/* 2nd level: hover */}
                <li>
                  <Link to="/contact" className="font-medium text-sm text-purple-100 hover:text-orange-100 flex py-2 px-4 leading-tight">Contact us</Link>
                </li>
                <li>
                  <Link to="/help" className="font-medium text-sm text-purple-100 hover:text-orange-100 flex py-2 px-4 leading-tight">Help center</Link>
                </li>
                <li>
                  <Link to="/404" className="font-medium text-sm text-purple-100 hover:text-orange-100 flex py-2 px-4 leading-tight">404</Link>
                </li>
              </Dropdown>
            </ul>
          </nav>
