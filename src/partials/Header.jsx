        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link to="/" className="block" aria-label="VSG">
              <svg className="w-8 h-8 fill-current text-purple-600 hover:text-gray-200" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <Dropdown title="Support">
                {/* 2nd level: hover */}
                <li>
                  <Link to="/contact" className="font-medium text-sm text-gray-900 hover:text-gray-200 flex py-2 px-4 leading-tight">Contact us</Link>
                </li>
                <li>
                  <Link to="/help" className="font-medium text-sm text-gray-900 hover:text-gray-200 flex py-2 px-4 leading-tight">Help center</Link>
                </li>
                <li>
                  <Link to="/404" className="font-medium text-sm text-gray-900 hover:text-gray-200 flex py-2 px-4 leading-tight">404</Link>
                </li>
              </Dropdown>
            </ul>
          </nav>
